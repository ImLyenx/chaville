...
export default function Commercants() {
  const [commercants, setCommercants] = useState<Array<{ id: string; name: string; description: string; logo: string; sector:string }>>([]);
  ...
  return (
    <section className="m:m-10 m-2">
      ...
      <div className="flex justify-center gap-20 mt-20">
        ...
        <Filtres onSectorChange={setSelectedSector} /> {/* Pass setSelectedSector to Filter */}
      </div>
